...
SERVER_SRC = $(SERVER_DIR)/server.c $(UTILS_DIR)/networkUtilities.c $(UTILS_DIR)/gameUtilities.c $(UTILS_DIR)/renderUtilities.c \
	  ...
	  $(MENU_UTILS_DIR)/commonMenuUtilities.c $(MENU_UTILS_DIR)/colorPickerUtilities.c $(MENU_UTILS_DIR)/lobbyMenuUtilities.c \
...
CLIENT_SRC = $(CLIENT_DIR)/client.c \
	...
	$(MENU_UTILS_DIR)/commonMenuUtilities.c $(MENU_UTILS_DIR)/loginMenuUtilities.c $(MENU_UTILS_DIR)/colorPickerUtilities.c $(MENU_UTILS_DIR)/lobbyMenuUtilities.c \
	$(OBJS_DIR)/level.c $(OBJS_DIR)/planet.c $(OBJS_DIR)/starship.c $(OBJS_DIR)/vec2.c $(OBJS_DIR)/faction.c $(OBJS_DIR)/player.c
